...
import { stepMasterDecide, type StepMasterInput } from '../src/stepmaster/stepmaster.core';
...
import type { MapMasterCandidate } from '../src/mapmaster/mapmaster.core';
...
describe('StepMaster Core', () => {
    ...
    it('filters out repetitive candidates', () => {
        ...
        const historyWithStep = {
            lastStep: {
                stepId: 'step-1',
                candidateId: 'cand-1' as any,
                decisionStatus: 'chosen' as const,
