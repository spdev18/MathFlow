...
import { buildGlobalMap, type GlobalMapBuilderInput } from "../src/mapmaster/mapmaster.global-map";
...
function createDebugRegistry(): InMemoryInvariantRegistry {
...
describe("Global Map Builder", () => {
    ...
    it("should build map for simple integer addition '1 + 2'", () => {
        const input: GlobalMapBuilderInput = {
            expressionLatex: "1 + 2",
            invariantSetIds,
            registry
        };
